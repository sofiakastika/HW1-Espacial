...
#importo shapefile
terrenos <- read_sf("C:/Users/sofia/Desktop/Maestría/Optativas/Segundo trimestre/Econometría Espacial/TP Espacial/Terrenos en venta 2019/Terrenos_venta_2019.shp")
...
class(terrenos) #como es un data.frame podemos usar también ggplot
summary(terrenos)
st_crs(terrenos)
terrenos1 <- st_transform(terrenos,5348) 
st_crs(terrenos1)
...
terrenos1[813, "longitud"] <- "-58.480852"



#guardo la base de datos como shapefile (para luego subir a GeoDa) 
st_write(terrenos1, "C:/Users/sofia/Desktop/Maestría/Optativas/Segundo trimestre/Econometría Espacial/TP Espacial/nuevo_shapefile1.shp", delete_layer = TRUE)
