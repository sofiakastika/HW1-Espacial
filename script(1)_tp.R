...
terrenos1$barrios <- ifelse(terrenos$barrio == "NU├æEZ", "NUÑEZ", terrenos$barrio)
...
label(terrenos1$lnpriceusd) <- "Logaritmo del precio en USD"
...
barrios <- c("almagro", "balvanera", "barrac_e", "barrac_o", "belgrano", 
             ...
             "san_cris", "san_nico", "san_telmo", "vl_sars", "versalles", 
             "vl_cresp", "vl_d_park", "vl_d_nor", "vl_d_sur", "vl_g_mtr", 
             "vl_lgn", "vl_luro", "vl_ortuzar", "vl_puerr", "vl_real", 
             "vl_riachu", "vl_st_rit", "vl_soldat", "vl_urqza")
...
modelo <- lm(lnpriceusd ~ m2total + almagro + balvanera + barrac_e + barrac_o +
               ...
               montserr + nva_pomp + palermo + p_avell + 
...
write.csv(terrenos1, "C:/Users/judit/OneDrive - Económicas - UBA/MaEcon/Econometría Espacial/Homeworks/HW1/terrenos1_con_residuos.csv", row.names = FALSE)


write.csv(terrenos1,"C:/Users/judit/OneDrive - Económicas - UBA/MaEcon/Econometría Espacial/Homeworks/HW1/dataset2.csv", row.names = FALSE)
