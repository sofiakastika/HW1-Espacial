...
# Guardo los residuos del modelo (para el punto 2)


# Elimino observaciones con celdas vacías para latitud o longitud para trabajar en GeoDA
terrenos2 <- terrenos1[!is.na(terrenos$longitud) & !is.na(terrenos$latitud), ]

# Exporto el dataset 
# Por favor, elija la ruta correspondiente a su carpeta de GitHub local
# write.csv(terrenos2,"C:/Users/sofia/Desktop/Maestría/Optativas/Segundo trimestre/Econometría Espacial/TP Espacial/dataset2.csv", row.names = FALSE)
write.csv(terrenos2, "/Users/tomasmarotta/Documents/GitHub/HW1-Espacial/dataset2.csv", row.names = FALSE)

library(sf)

# Convertir tu data frame a un objeto sf (simple feature)
terrenos_sf <- st_as_sf(terrenos2, coords = c("longitud", "latitud"), crs = 4326)

# Guardar como shapefile
st_write(terrenos_sf, "/Users/tomasmarotta/Documents/GitHub/HW1-Espacial/terrenos_geo.shp")